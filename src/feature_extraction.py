...
EYE_POSITION_LEFT_X = 'Eye position left X'
EYE_POSITION_LEFT_Y = 'Eye position left Y'
EYE_POSITION_LEFT_Z = 'Eye position left Z'
EYE_POSITION_RIGHT_X = 'Eye position right X'
EYE_POSITION_RIGHT_Y = 'Eye position right Y'
EYE_POSITION_RIGHT_Z = 'Eye position right Z'
