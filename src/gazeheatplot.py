# 
# We utilize the plot code from https://github.com/esdalmaijer/PyGazeAnalyser/blob/master/pygazeanalyser/gazeplotter.py
# 
import os
import argparse
import csv
...
def draw_display(dispsize, imagefile=None, **kwargs):
    ...
    keywords        -   image: raw stimuli image
    returns
...
def draw_heatmap(gazepoints, dispsize, imagefile=None, alpha=0.5, savefilename=None, gaussianwh=200, gaussiansd=None, **kwargs):
    ...
    # IMAGE
    fig, ax = draw_display(dispsize, imagefile=imagefile, **kwargs)
